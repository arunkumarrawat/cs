...
#pragma warning restore 618
        ...
        private void WaitForWaitHandle(WaitHandle waitHandle)
        {
            ...
            while (!processed)
            {
                ...
                //Dev10 Bug 600316: Because Control.Invoke() is not fully thread safe, so it is possible that a 
                //ThreadMethodEntry can be sent to a control after it is disposed. 
                if (IsDisposed)
                {
